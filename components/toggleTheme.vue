<template>
    <div :class="$props.class"
        class="cursor-pointer p-3 rounded-full flex justify-center items-center hover:bg-[var(--shadow-color)]"
        v-on:click="app.setAppTheme">
        <svg v-if="app.theme === 'light'" xmlns="http://www.w3.org/2000/svg" :width="$props.size" :height="$props.size"
        ...
        <svg v-else-if="app.theme === 'dark'" xmlns="http://www.w3.org/2000/svg" :width="$props.size"
            :height="$props.size" fill="#ffffff" viewBox="0 0 256 256">
            <path
