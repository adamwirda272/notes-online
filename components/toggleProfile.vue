<template>
    <div v-on:click="app.setProfileModal"
        class="cursor-pointer flex justify-center items-center w-[70px] h-auto rounded-bl-full rounded-tl-full p-2 pr-2 hover:bg-[var(--border-color)] text-[var(--text-color)]">
